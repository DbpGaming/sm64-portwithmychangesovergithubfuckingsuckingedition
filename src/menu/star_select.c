...
#ifdef VERSION_EU
        print_generic_string(95, 118, myScore[language]);//fixme
#else
...
#ifdef VERSION_EU
    print_course_number(language);//fixme
#else
    print_course_number();
#endif
...
#ifdef VERSION_EU
        print_menu_generic_string(get_str_x_pos_from_center(ACT_NAME_X, selectedActName, 8.0f), 81, selectedActName); //fixme
#else
